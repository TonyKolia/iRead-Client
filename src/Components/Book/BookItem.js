        ...
        <div className="col">
            <div className="card card-custom">
                ...
                <div className="card-body">
                    ...
                    <button type="button" onClick={() => basketContext.dispatchBasket({ type: BASKET_ACTIONS.ADD_ITEM, payload: { itemId: props.book.id } })} className="btn btn-primary btn-custom ripple card-btn"><i className="fa-solid fa-basket-shopping"></i>Προσθήκη στο καλάθι</button>
                </div>
            </div>
        </div>
    );
