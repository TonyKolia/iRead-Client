...
export default function BookPage() {
    ...
    var url = "https://localhost:7190/api/Book/" + id;
    ...
    return (
        ...
        Object.keys(book).length === 0 ? <div>LOADINGGGGGG</div> :
                ...
                <div className="card book-container mb-3">
                    <div className="row g-0">
                        <div className="col-md-4">
                            ...
                            <img src={"https://localhost:7190/api/Image/Book/" + book.imagePath} className="img-fluid book-img" alt="..." />
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <h4>{book.title}</h4>
                                <ul className="list-group">
                                    <li key="authors" className="list-group-item">Συγγραφείς: {book.authors?.map(author => <a href={"/author/" + author.id}>{author.name + " " + author.surname}</a>)}</li>
                                    <li key="categories" className="list-group-item">Κατηγορίες: {book.categories?.map(category => <a href="#">{category.description}</a>)} </li>
                                    <li key="isbn" className="list-group-item">ISBN: {book.isbn}</li>
                                    <li key="publishers" className="list-group-item">Εκδόσεις: <a href="#">Φουσέκης</a></li>
                                    <li key="publishDate" className="list-group-item">Ημερομηνία έκδοσης: 24/04/2022</li>
