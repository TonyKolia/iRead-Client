...
const ENDPOINTS = {
    ...
    GET_ORGANIZED_NOTIFICATIONS: "Notification/GetOrganized/:userId",
    GET_BOOKS_FOR_HOME: "Book/ForHome/:userId",
    POST_ACTIVATE_ACCOUNT: "Account/ActivateAccount/:userId/:token",
    POST_SEND_RESET_PASSWORD_EMAIL: "Account/SendPasswordResetEmail/:email",
    POST_RESET_PASSWORD: "Account/ResetPassword/:userId/:token"
};
...
const development = {
    ...
    API_URL_GET_ORGANIZED_NOTIFICATIONS: `${API_BASE_URL}${ENDPOINTS.GET_ORGANIZED_NOTIFICATIONS}`,
    API_URL_GET_BOOKS_FOR_HOME: `${API_BASE_URL}${ENDPOINTS.GET_BOOKS_FOR_HOME}`,
    API_URL_POST_ACTIVATE_ACCOUNT: `${API_BASE_URL}${ENDPOINTS.POST_ACTIVATE_ACCOUNT}`,
    API_URL_POST_SEND_RESET_PASSWORD_EMAIL: `${API_BASE_URL}${ENDPOINTS.POST_SEND_RESET_PASSWORD_EMAIL}`,
    API_URL_POST_RESET_PASSWORD: `${API_BASE_URL}${ENDPOINTS.POST_RESET_PASSWORD}`
};
